...
namespace Mosa.Platforms.x86
{
    ...
    public static class Native
    {
        ...
        public static void Ldit (IntPtr idt)
        {
        ...
        public static void CmpXchg16 (ref short first, short second)
        {
            ThrowPlatformNotSupported ();
            return;
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.CmpXchgInstruction))]
        public static void CmpXchg32 (ref int first, int second)
        {
            ThrowPlatformNotSupported ();
            return;
        }
        ...
        public static void Lgdt (IntPtr gdt)
        {
            ThrowPlatformNotSupported ();
            return;
        }
        ...
        public static void Push16 (short value)
        {
            ThrowPlatformNotSupported ();
            return;
        }
        ...
        unsafe public static byte In (byte address)
        {
            ThrowPlatformNotSupported ();
            return 0;
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.InInstruction))]
        unsafe public static byte In8 (byte address)
        {
            ThrowPlatformNotSupported ();
            return 0;
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.InInstruction))]
        unsafe public static ushort In16 (ushort address)
        {
            ThrowPlatformNotSupported ();
            return 0;
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.InInstruction))]
        unsafe public static uint In32 (uint address)
        {
            ThrowPlatformNotSupported ();
            return 0;
        }
        ...
        unsafe public static void Out8 (byte address, byte value)
        {
            ThrowPlatformNotSupported ();
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.OutInstruction))]
        unsafe public static void Out (byte address, byte value)
        {
            ThrowPlatformNotSupported ();
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.OutInstruction))]
        unsafe public static void Out16 (ushort address, ushort value)
        {
            ThrowPlatformNotSupported ();
        }
        ...
        /// </summary>
        [Intrinsic(typeof(Architecture), typeof(CPUx86.OutInstruction))]
        unsafe public static void Out32 (uint address, uint value)
        {
            ThrowPlatformNotSupported ();
        }
        ...
        unsafe public static byte* CpuId (uint function)
        {
            ThrowPlatformNotSupported ();
            return null;
        }
