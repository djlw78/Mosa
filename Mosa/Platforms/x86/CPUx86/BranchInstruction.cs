...
namespace Mosa.Platforms.x86.CPUx86
{
    ...
    public sealed class BranchInstruction : BaseInstruction
    {
        ...
        private static readonly byte[] JAE = new byte[] {
            0xf,
            0x83
        };
        private static readonly byte[] JNE = new byte[] {
            0xf,
            0x85
        };
        private static readonly byte[] JL = new byte[] {
            0xf,
            0x8c
        };
        private static readonly byte[] JLE = new byte[] {
            0xf,
            0x8e
        };
        private static readonly byte[] JG = new byte[] {
            0xf,
            0x8f
        };
        private static readonly byte[] JGE = new byte[] {
            0xf,
            0x8d
        };
        private static readonly byte[] JE = new byte[] {
            0xf,
            0x84
        };
        private static readonly byte[] JBE = new byte[] {
            0xf,
            0x86
        };
        private static readonly byte[] JA = new byte[] {
            0xf,
            0x87
        };
        private static readonly byte[] JB = new byte[] {
            0xf,
            0x82
        };
        private static readonly byte[] JNS = new byte[] {
            0xf,
            0x89
        };
        private static readonly byte[] JS = new byte[] {
            0xf,
            0x88
        };
