...
namespace Mosa.Platforms.x86.CPUx86
{
    ...
    public sealed class AddInstruction : TwoOperandInstruction
    {
        ...
        private static readonly OpCode R_M = new OpCode (new byte[] { 0x3 });
        private static readonly OpCode R_R = new OpCode (new byte[] { 0x3 });
        private static readonly OpCode M_R = new OpCode (new byte[] { 0x1 });
