...
namespace Mosa.Platforms.x86.CPUx86
{
    ...
    public sealed class MovInstruction : TwoOperandInstruction, IIntrinsicInstruction
    {
        ...
        private static readonly OpCode R_C = new OpCode (new byte[] { 0xc7 }, 0);
        // Move imm32 to r/m32
        private static readonly OpCode M_C = new OpCode (new byte[] { 0xc7 }, 0);
        private static readonly OpCode R_R = new OpCode (new byte[] { 0x8b });
        private static readonly OpCode R_R_16 = new OpCode (new byte[] {
            0x66,
            0x8b
        });
        private static readonly OpCode R_R_U8 = new OpCode (new byte[] { 0x88 });
        private static readonly OpCode R_M = new OpCode (new byte[] { 0x8b });
        // Move r/m32 to R32
        private static readonly OpCode R_M_16 = new OpCode (new byte[] {
            0x66,
            0x8b
        });
        private static readonly OpCode M_R = new OpCode (new byte[] { 0x89 });
        private static readonly OpCode M_R_16 = new OpCode (new byte[] {
            0x66,
            0x89
        });
        private static readonly OpCode M_R_U8 = new OpCode (new byte[] { 0x88 });
        // Move R8 to r/rm8
        private static readonly OpCode R_M_U8 = new OpCode (new byte[] { 0x8a });
        // Move r/m8 to R8
        #endregion
