    ...
    public sealed class Context
    {
        ...
        public Operand Operand1 {
            ...
            set {
                ...
                if (current != null)
                    current.Uses.Remove (_index);
                if (value != null)
                    value.Uses.Add (_index);
        ...
        public Operand Result {
            ...
            set {
                ...
                if (current != null)
                    current.Definitions.Remove (_index);
                if (value != null)
                    value.Definitions.Add (_index);
        ...
        {
            if (Branch == null)
                Branch = new Branch (2); else if (Branch.Targets.Length < 2)
            {
        ...
        public Operand GetOperand (int index)
        {
            ...
            case 2:
                return Operand3;
            default:
                return _instructionSet.Data[_index].GetAdditionalOperand (index);
            }
        }
