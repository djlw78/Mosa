...
namespace Mosa.Runtime.CompilerFramework
{
    ...
    public abstract class BaseInstruction : IInstruction
    {
        ...
        public byte DefaultOperandCount {
            get { return _operandDefaultCount; }
        }
        ...
        public byte DefaultResultCount {
            get { return _resultDefaultCount; }
        }
        ...
        public virtual string ToString (Context context)
        {
            ...
            if (context.ResultCount == 1)
                s = s + " " + context.Result; else if (context.ResultCount == 2)
