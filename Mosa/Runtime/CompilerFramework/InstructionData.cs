...
namespace Mosa.Runtime.CompilerFramework
{
    ...
    public struct InstructionData
    {
        ...
        /// </summary>
        public bool Ignore {
            get { return (_packed & 0x1) == 0x1; }
            set {
                if (value)
                    _packed = _packed | 0x1;
                else
                    _packed = (uint)(_packed & ~0x1);
            }
        }
        ...
        public bool BranchHint {
            get { return (_packed & 0x4) == 0x4; }
            set {
                if (value)
                    _packed = _packed | 0x4;
                else
                    _packed = (uint)(_packed & ~0x4);
            }
        }
        ...
        public byte ResultCount {
            ...
            set { _packed = (uint)((_packed & 0xff00ffffu) | ((uint)value << 16)); }
        }
        ...
        public byte OperandCount {
            ...
            set { _packed = (uint)((_packed & 0xffffff) | ((uint)value << 24)); }
        }
        ...
        public RuntimeMethod InvokeTarget {
            get {
                if (!(Other is RuntimeMethodData))
                    return null;
                return (Other as RuntimeMethodData).RuntimeMethod;
            }
            set {
                if (!(Other is RuntimeMethodData))
                    Other = new RuntimeMethodData (value);
                else
                    (Other as RuntimeMethodData).RuntimeMethod = value;
            }
        }
