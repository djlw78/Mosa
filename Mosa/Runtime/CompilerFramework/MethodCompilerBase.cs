...
namespace Mosa.Runtime.CompilerFramework
{
    ...
    public class MethodCompilerBase : CompilerBase, IMethodCompiler, IDisposable
    {
        ...
        public Operand CreateTemporary (SigType type)
        {
            ...
            return new LocalVariableOperand (_architecture.StackFrameRegister, String.Format ("T_{0}", stackSlot), stackSlot, type);
        }
        ...
        public Operand GetParameterOperand (int index)
        {
            ...
            if (param == null)
            {
                param = new ParameterOperand (_architecture.StackFrameRegister, parameters[index], sig.Parameters[index]);
        ...
        {
            return _basicBlocks.Find (delegate(BasicBlock block) { return (label == block.Label); });
        }
